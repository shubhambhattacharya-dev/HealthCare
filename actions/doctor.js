...
// ============================================
// NEW EXPORTS ADDED TO FIX IMPORT ERRORS
// ============================================

/**
 * Set availability slots (alias for backward compatibility)
 */
export const setAvailableSlots = setAvailabilitySlots;

/**
 * Get doctor's availability (alias for backward compatibility)
 * @deprecated Use getDoctorAvailability instead
 */
